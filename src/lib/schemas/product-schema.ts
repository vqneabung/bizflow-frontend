...
/** Optional string (không validate format) — cho phép '' hoặc undefined, max 100 chars */
const optionalString = z.string().max(100).optional().or(z.literal(""));
